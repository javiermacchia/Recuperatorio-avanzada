...
<body>
	...
	<form method="GET" action="./servletLogin">
		...
		<div class="d-grid">
			<button class="btn btn-primary" type="submit" name="salir" id="salir">Salir</button>
			<button class="btn btn-primary" type="submit" name="cancelar" id="cancelar">Cancelar</button>
		</div>
